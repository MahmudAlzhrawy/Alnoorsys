...
export default function Navbar(){
    ...
    <div className="main">
        ...
        <div className="linkes items-center flex max-[700px]:hidden">
        <Link className="mr-5 text-xl font-bold font-sans bg-blue-500 bg-opacity-50 p-2 rounded-xl hover:brightness-75" href={"/report"}>مستحقين الدفع</Link>
        ...
        <div className="linkes items-center flex min-[700px]:hidden">
            <DropList/>
        </div>
        </div>
    </div>
